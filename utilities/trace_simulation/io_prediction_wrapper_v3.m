function simInfoPD = io_prediction_wrapper_v3(mcmcInfo)
    ...
    K_out = mcmcInfo.param_fit_array(mcmcInfo.step,strcmp(paramList,'ks'));
    K_in = mcmcInfo.param_fit_array(mcmcInfo.step,strcmp(paramList,'ka'));
