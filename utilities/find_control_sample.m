function [null_x, null_y, null_nc, qc_flag, null_mask,dist_mat_nn] = find_control_sample(dist_vec, x_ref, y_ref, x_spot, y_spot, spot_dist,...
    nc_x_vec, nc_y_vec, spot_x_vec, spot_y_vec, index, null_mask_spot, r_dist_mat, min_sample_sep, histone_image,id_array, nb_sz, nc_index_vec, area_bounds)
