...
burst_k_on_mean_CONST = CONST_temp_bursting.compiledResults.freq_vec_mean;
burst_k_on_ste_CONST = CONST_temp_bursting.compiledResults.freq_vec_ste;
...
errorbar(burst_axis,burst_k_on_mean_CONST,burst_k_on_ste_CONST,'Color','k','CapSize',0)
plot(burst_axis,burst_k_on_mean_WT,'-k')
plot(burst_axis,burst_k_on_mean_CONST,'-k')
scatter(burst_axis,burst_k_on_mean_WT,50,'MarkerFaceColor',yw,'MarkerEdgeColor','k')
scatter(burst_axis,burst_k_on_mean_CONST,50,'MarkerFaceColor',bl,'MarkerEdgeColor','k')

errorbar(burst_axis,burst_k_off_mean_WT,burst_k_off_ste_WT,'Color','k','CapSize',0)
errorbar(burst_axis,burst_k_off_mean_CONST,burst_k_off_ste_CONST,'Color','k','CapSize',0)
plot(burst_axis,burst_k_off_mean_WT,'-k')
plot(burst_axis,burst_k_off_mean_CONST,'-k')
scatter(burst_axis,burst_k_off_mean_WT,50,'MarkerFaceColor',yw,'MarkerEdgeColor','k')
scatter(burst_axis,burst_k_off_mean_CONST,50,'MarkerFaceColor',bl,'MarkerEdgeColor','k')
%set(gca,'YColor',bl);
ylabel(['transition rates (1/min)'])
ylim([0 10])
