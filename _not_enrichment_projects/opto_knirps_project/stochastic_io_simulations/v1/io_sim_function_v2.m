...
if contains(simInfo.simType,'in') % this signifies 3 state system where rate from SILENT -> OFF is regulated
...
elseif contains(simInfo.simType,'kon')      
    simInfo.HC = -simInfo.HC;
    simInfo.tf_dependent_flags(3,2) = true;
elseif contains(simInfo.simType,'koff')          
