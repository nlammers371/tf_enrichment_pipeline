...
burstDur_vs_surgeMag_fig = figure(6);
hold on
% Fixed 2 min, raw
...
saveas(burstDur_vs_surgeMag_fig, [FigPath 'burstDur_vs_surgeDur' '.pdf'])
saveas(burstDur_vs_surgeMag_fig, [FigPath 'burstDur_vs_surgeDur' '.tif'])


burstDur_vs_surgeMagActBurstDur_fig = figure(7);
hold on
% Actual burst duration
...
burstDur_vs_surgeRate_fig = figure(8);
hold on
% 20s
