...
s1 = scatter(offset_mean(set_index<10&sna_filter),fluo_mean(set_index<10&sna_filter),'MarkerFaceColor',cmap2(2,:),'MarkerEdgeAlpha',0);
...
set(gca,'Fontsize',14)
ylim([0 500])
saveas(fig,[FigPath 'hb_mcp_vs_fluo.png'])    
