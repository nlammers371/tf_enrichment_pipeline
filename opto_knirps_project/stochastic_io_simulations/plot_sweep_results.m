...
saveas(p_on_fit_fig,[FigurePath 'p_on_fit_' simType '.png'])
...
legend('best fit','experimental data','Location','southwest')
saveas(fluo_fit_fig,[FigurePath 'fluo_fit_' simType '.png'])
...
set(gca,'yscale','log');
grid on
saveas(kd_fig,[FigurePath 'KD_fit_scatter_' simType '.png'])
...
set(gca,'yscale','log');
grid on
saveas(thresh_fig,[FigurePath 'thresh_fit_scatter_' simType '.png'])
...
ylabel('residual error')
grid on
saveas(Kout_fig,[FigurePath 'kout_fit_scatter_' simType '.png'])
...
ylabel('residual error')
grid on
saveas(Kin_fig,[FigurePath 'kin_fit_scatter_' simType '.png'])
...
set(gca,'Fontsize',14)
xlabel('minutes from perturbation')
saveas(ex_fig,[FigurePath 'io_trace_' simType '.png'])
...
set(gca,'Fontsize',14)
xlabel('minutes from perturbation')
saveas(ex_fig,[FigurePath 'io_rate_' simType '.png'])
