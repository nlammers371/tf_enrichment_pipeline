...
%         subplot(1,2,1)
        ...
        p.AlphaData = .4;        
        s1 = scatter(qc_spot.xp-x_center+xDim,qc_spot.yp-y_center+yDim,40,'MarkerFaceColor',cm(30,:),'MarkerEdgeColor','black');
        s2 = scatter(qc_spot.xc_edge-x_center+xDim,qc_spot.yc_edge-y_center+yDim,30,'MarkerFaceColor',cm(90,:),'MarkerEdgeAlpha',0);        
        s3 = scatter(qc_spot.xp_sister-x_center+xDim,qc_spot.yp_sister-y_center+yDim,40,'d','MarkerFaceColor',cm(60,:),'MarkerEdgeColor','black');        
